...
$dispatcher = FastRoute\simpleDispatcher(function(FastRoute\RouteCollector $r) {
    ...
    $r->addGroup('/admin', function ($r) {
        ...
        $r->addRoute('GET', '/articles', 'admin_articles_index');
        $r->addRoute('GET', '/articles/create', 'admin_articles_create');
        $r->addRoute('POST', '/articles', 'admin_articles_store');
        $r->addRoute('GET', '/articles/{id:\d+}/edit', 'admin_articles_edit');
        $r->addRoute('PUT', '/articles/{id:\d+}', 'admin_articles_update');
        $r->addRoute('DELETE', '/articles/{id:\d+}', 'admin_articles_delete');
    });
});
